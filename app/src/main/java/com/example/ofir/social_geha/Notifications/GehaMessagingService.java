...
/**
 * A utility Service (runs in background) used to handle FCM (Firebase Cloud Messages) sent by Firebase server to the
 * device's app.
 */
public class GehaMessagingService extends FirebaseMessagingService {
    ...
    /**
     * Creates a notification on the device
     * @param remoteMessage - the message received that was sent by the Firebase server
     */
    ...
    /**
     * Handles the intent that will occur according to the type of message that was received.
     * @param notificationBuilder - the notification builder
     * @param clickAction - the type of action to perform - not used
     * @param remoteMessage - the message received that was sent by the Firebase server
     */
    ...
    //When a new token is generated by the device, store it.
    @Override
    ...
    /**
     * Stores the deviceToken on the server
     * @param auth - Firebase Auth.
     * @param database - Firebase database
     * @param devToken - the token to store
     */
    ...
    //FOR Android API >= 26, notifications require channels, initialize them.
